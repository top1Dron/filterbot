...
# message.from_user.id in ADMINS and 
...
async def delete_messages_with_forbidden_words_command(message: types.Message):
    await misc.delete_old_messages_with_forbidden_words(chat_id=message.chat.id)


@dp.callback_query_handler(lambda callback_query: True,
# callback_query.from_user.id in ADMINS, 
...
# callback_query.from_user.id in ADMINS and
...
# message.from_user.id in ADMINS 
    # and 
    message.chat.id in db_utils.get_bot_groups(), state=WordsStates.REMOVE_WORD)
